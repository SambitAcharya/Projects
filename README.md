...
[**Find PI to the Nth Digit**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Numbers/pi.py) - Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[**Find e to the Nth Digit**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Numbers/e.py) - Just like the previous problem, but with e instead of PI. Enter a number and have the program generate e up to that many decimal places. Keep a limit to how far the program will go.
...
[**Fizz Buzz**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Text/fizzbuzz.py) - Write a program that prints the numbers from 1 to 100. But for multiples of three print “Fizz” instead of the number and for the multiples of five print “Buzz”. For numbers which are multiples of both three and five print “FizzBuzz”.

[**Reverse a String**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Text/reversestring.py) - Enter a string and the program will reverse it and print it out.

[**Pig Latin**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Text/piglatin.py) - Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Text/countvowels.py) - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.
...
[**FTP Program**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Networking/ftptransfer.py) - A file transfer program which can transfer files back and forth from a remote web sever.
...
[**Country from IP Lookup**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Networking/iplookup.py) - Enter an IP address and find the country that IP is registered in. *Optional: Find the Ip automatically.*

[**Whois Search Tool**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Networking/whois.py) - Enter an IP or host address and have it look it up through whois and return the results to you.
...
[**Turtle Graphics**](https://github.com/SambitAcharya/Projects/blob/master/My%20Solutions/Graphics-And-Multimedia/turtlegraphics.py) - This is a common project where you create a floor of 20 x 20 squares. Using various commands you tell a turtle to draw a line on the floor. You have move forward, left or right, lift or drop pen etc. Do a search online for "Turtle Graphics" for more information. *Optional: Allow the program to read in the list of commands from a file.*
